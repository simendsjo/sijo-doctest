...
** [[https://github.com/simendsjo/sijo-doctest/compare/v0.4.0..v0.4.1][0.4.1]] - 2025-08-13
*** Added
*** Changed
*** Deprecated
*** Removed
*** Fixed
- [[https://github.com/simendsjo/sijo-doctest/issues/9][issue#9]] ~test-file~ doesn't work. It tried to call non-existing function
  ~test-docstrting~, a typo for ~test-docstring~ which doesn't work with an
  ~fd-stream~ anyway. Corrected to call ~run-doctests~.
*** Security
